...
public class TripHistoryController {
    ...
    public ApiResponse<com.kaitohuy.chiabill.dto.response.PageResponse<TripHistoryResponse>> getTripHistory(
        ...
        org.springframework.data.domain.Page<TripHistoryResponse> historyPage = tripHistoryService.getTripHistoryPaginated(tripId, userId, actions, startDate, endDate, pageable);
